...
RUN mkdir -p /opt/flutter && sudo chown -R circleci /opt/flutter && curl "${flutter_version_url}" --output ./flutter.tar.xz && tar xf ./flutter.tar.xz && rm ./flutter.tar.xz && sudo chown -R circleci /opt/flutter
